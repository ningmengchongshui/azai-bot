...
if (qq.qq)
  writeYaml('config/ICQQ.yaml', {
    bot,
    token: [`${qq.qq}:${qq.pwd}:${qq.platform}`]
  })
rm('plugins/genshin')
exec(
  'git clone --depth 1 --single-branch https://gitee.com/TimeRainStarSky/Yunzai-genshin plugins/genshin'
)
